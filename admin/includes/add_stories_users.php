...
<div class="col-lg-8">
    <hr>
    <h3 class="text-left p-3" style="border:1px solid #eee;background-color:lightblue; ">Share Your Story!</h3>
    <br>
    <hr>
    <?php
...
<?php
            ...
            $query=mysqli_query($connection,"SELECT is_banned FROM users WHERE username='$name'");
    ...
    <form action="admin/includes/function.php" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <input type="submit" name="save-user" value="Save" class="btn btn-success btn-block btn-md">
                </div>
            </div>
        </div>
    </form><?php }
    else{
        echo " <div class='alert alert-warning'>Sorry you cannot post stories! You have been blocked by the admin</div>";
    }
    ?>
</div>
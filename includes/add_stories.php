...
<div class="col-lg-8">
    ...
    <form action="includes/functions.php" method="post" enctype="multipart/form-data" autocomplete="off">
    	 <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" name="author" id="" value="<?php  echo $_SESSION['user_username']; ?>"class="form-control" placeholder="Post Author" disabled>
        </div>
